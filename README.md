...
|  **Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software** | **Daniel Aquino** <br> **AV1:** Diagramas de Event Storming. Bounded Context Canvases. Domain Message Flow Modeling. Context Mapping. <br><br> **Giuliano Peláez** <br> **AV1:** Análisis de datos demográficos de INEI y APEIM para el perfilado de usuarios. Estructuración del **Startup Profile**, misión y visión. Documentación de antecedentes y problemática del sector energético para sustentar la viabilidad de la solución. |  |
---
